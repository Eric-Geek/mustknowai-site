...
export default function LandingPage({ t, title, description }: InferGetStaticPropsType<typeof getStaticProps>) {
  ...
  const featuredTools = [
    {
      icon: (
        <Image
          src="/icons/tools/chatgpt-icon.png" // 指向您在 public/icons/tools/ 下的文件
          alt="ChatGPT Plus Logo"
          width={32} // 因为您的图片已经是 32x32
          height={32}
          className="object-contain" // 通常这个类可以省略，因为图片已经是目标尺寸
        />
      ),
      name: "ChatGPT Plus",
      pitch: "高级AI对话，处理复杂任务", // 考虑从 t 对象获取 pitch: t.chatGPTPlusPitch
    ...
    },
    {
      icon: (
        <Image
          src="/icons/tools/midjourney-icon.jpg" // 注意文件名和格式
          alt="Midjourney Logo"
          width={32}
          height={32}
      ...
      name: "Midjourney",
      pitch: "创作令人惊叹的AI生成艺术品", // t.midjourneyPitch
    ...
    },
    {
      icon: (
        <Image
          src="/icons/tools/github-copilot-icon.jpg" // 注意文件名和格式
      ...
      name: "GitHub Copilot",
      pitch: "AI驱动的代码补全和辅助", // t.githubCopilotPitch
    ...
    },
    {
      icon: (
        <Image
          src="/icons/tools/notion-icon.jpg" // 注意文件名和格式
          alt="Notion AI Logo"
          width={32}
          height={32}
          className="object-contain"
      ...
      name: "Notion AI",
      pitch: "提高生产力的智能写作助手", // t.notionAiPitch
    ...
    },
    {
      icon: (
        <Image
          src="/icons/tools/runway-icon.jpg" // 注意文件名和格式
          alt="RunwayML Logo"
          width={32}
          height={32}
          className="object-contain"
      ...
      name: "RunwayML",
      pitch: "AI视频编辑和生成工具", // t.runwayMlPitch
    ...
    },
    {
      icon: (
        <Image
          src="/icons/tools/claude-icon.jpg" // 注意文件名和格式
          alt="Claude AI Logo"
          width={32}
          height={32}
          className="object-contain"
      ...
      name: "Claude AI",
      pitch: "乐于助人的AI助手，用于分析和写作", // t.claudeAiPitch
  ...
  const categories = [
    {
      icon: <DefaultPenTool className="h-12 w-12" />,
    ...
    {
      icon: <DefaultImageIcon className="h-12 w-12" />,
    ...
    {
      icon: <DefaultVideoIcon className="h-12 w-12" />,
    ...
    {
      icon: <DefaultCodeIcon className="h-12 w-12" />,
