-- Supabase database migration for MustKnowAI site (Alternative Version)
-- 创建AI工具目录网站所需的数据库表
-- 此版本允许重复的工具标题
...
-- 插入一些示例工具数据 (使用组合唯一约束)
insert into public.tools (title, description, category, pricing, featured, tags, link) values
  ('ChatGPT', 'Advanced AI chatbot for conversations and assistance', 'chatbot', 'freemium', true, '{"conversation", "ai-assistant", "openai"}', 'https://chat.openai.com'),
  ('DALL-E 2', 'AI image generation from text descriptions', 'image', 'paid', true, '{"image-generation", "ai-art", "openai"}', 'https://openai.com/dall-e-2'),
  ('Grammarly', 'AI-powered writing assistant and grammar checker', 'writing', 'freemium', false, '{"writing", "grammar", "proofreading"}', 'https://grammarly.com'),
  ('Notion AI', 'AI-powered productivity and note-taking tool', 'productivity', 'freemium', false, '{"notes", "productivity", "ai-writing"}', 'https://notion.so'),
  ('Runway ML', 'AI video editing and generation platform', 'video', 'freemium', true, '{"video-editing", "ai-video", "creative"}', 'https://runwayml.com')
